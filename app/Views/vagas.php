<!-- Hero Header -->
<div class="mb-10">
    <h2 class="text-4xl font-black text-slate-900 dark:text-white mb-2">Vagas de Estágio</h2>
    <p class="text-slate-600 dark:text-slate-400 text-lg">Impulsione sua carreira dentro do CEFET.</p>
</div>
...
<div class="flex flex-col lg:flex-row gap-8">
    ...
    <aside class="w-full lg:w-64 flex-shrink-0">
        <div class="sticky top-24 space-y-6">
            <div>
                <h3 class="text-sm font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-4">Departamentos</h3>
                <div class="space-y-2">
            ...
            <div class="job-card flex flex-col md:flex-row gap-6 group">
                ...
                <div class="flex-1">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors"> <?php echo "NOME DA VAGA"?> </h3>
